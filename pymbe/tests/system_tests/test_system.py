...
examples = [
    ...
    (['ch2', 'ccsd', 'dipole', 'can', 'vac', ''], np.array([0., 0.22522662, 0.])),
    (['ch2', 'ccsd', 'dipole', 'can', 'occ', ''], np.array([0., 0.22918130, 0.])),
    (['ch2', 'ccsd', 'dipole', 'can', 'mixed', ''], np.array([0., 0.22948878, 0.])),
    (['ch2', 'ccsd(t)', 'energy', 'can', 'vac', ''], -38.980723),
    (['ch2', 'ccsd(t)', 'energy', 'can', 'occ', ''], -38.979818),
    (['ch2', 'ccsd(t)', 'energy', 'can', 'mixed', ''], -38.979822),
    (['ch2', 'ccsd(t)', 'dipole', 'can', 'vac', ''], np.array([0., 0.22567981, 0.])),
    (['ch2', 'ccsd(t)', 'dipole', 'can', 'occ', ''], np.array([0., 0.22887061, 0.])),
    (['ch2', 'ccsd(t)', 'dipole', 'can', 'mixed', ''], np.array([0., 0.22918507, 0.])),
