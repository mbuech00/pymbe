...
examples = [
    ...
    (["h2o", "ccsd", "dipole", "can", "occ"], np.array([0.0, 0.0, -0.99220032])),
    (["h2o", "ccsd", "dipole", "can", "mixed"], np.array([0.0, 0.0, -0.99423554])),
    (["h2o", "ccsd(t)", "energy", "can", "vac"], -76.126560),
    (["h2o", "ccsd(t)", "energy", "can", "occ"], -76.119334),
    (["h2o", "ccsd(t)", "energy", "can", "mixed"], -76.119171),
    (["h2o", "ccsd(t)", "dipole", "can", "occ"], np.array([0.0, 0.0, -0.99122177])),
    (["h2o", "ccsd(t)", "dipole", "can", "mixed"], np.array([0.0, 0.0, -0.99351814])),
    ...
    (["h2o", "fci", "dipole", "can", "vac"], np.array([0.0, 0.0, -0.98870004])),
    (["h2o", "fci", "dipole", "can", "occ"], np.array([0.0, 0.0, -0.98991406])),
    (["h2o", "fci", "dipole", "can", "mixed"], np.array([0.0, 0.0, -0.99274173])),
    (["h2o", "fci", "dipole", "can", "vac", "ccsd"], np.array([0.0, 0.0, -0.99864001])),
    (["h2o", "fci", "dipole", "can", "occ", "ccsd"], np.array([0.0, 0.0, -0.99096101])),
    (
        ["h2o", "fci", "dipole", "can", "mixed", "ccsd"],
        np.array([0.0, 0.0, -0.99260507]),
    ),
    (
        ["h2o", "fci", "dipole", "can", "vac", "ccsd(t)"],
        np.array([0.0, 0.0, -0.99304722]),
    ),
    (
        ["h2o", "fci", "dipole", "can", "occ", "ccsd(t)"],
        np.array([0.0, 0.0, -0.99143106]),
    ),
    (
        ["h2o", "fci", "dipole", "can", "mixed", "ccsd(t)"],
        np.array([0.0, 0.0, -0.99262394]),
    ),
    (["h2o", "fci", "dipole", "ccsd", "vac"], np.array([0.0, 0.0, -1.0006686])),
    (["h2o", "fci", "dipole", "ccsd", "occ"], np.array([0.0, 0.0, -0.99143464])),
    (["h2o", "fci", "dipole", "ccsd", "mixed"], np.array([0.0, 0.0, -0.99254520])),
    (["h2o", "fci", "dipole", "ccsd(t)", "vac"], np.array([0.0, 0.0, -1.0002103])),
    (["h2o", "fci", "dipole", "ccsd(t)", "occ"], np.array([0.0, 0.0, -0.99131529])),
    (["h2o", "fci", "dipole", "ccsd(t)", "mixed"], np.array([0.0, 0.0, -0.99254059])),
    (["h2o", "fci", "excitation", "can", "mixed"], 4.05755e-01),
    (["h2o", "fci", "trans", "can", "mixed"], np.array([0.0, 0.0, 0.65402456])),
    (["ch2", "ccsd", "energy", "can", "vac"], -38.980256),
    (["ch2", "ccsd", "energy", "can", "occ"], -38.979269),
    (["ch2", "ccsd", "energy", "can", "mixed"], -38.979216),
    (["ch2", "ccsd", "dipole", "can", "vac"], np.array([0.0, 0.22522662, 0.0])),
    (["ch2", "ccsd", "dipole", "can", "occ"], np.array([0.0, 0.22918130, 0.0])),
    (["ch2", "ccsd", "dipole", "can", "mixed"], np.array([0.0, 0.22948878, 0.0])),
    (["ch2", "ccsd(t)", "energy", "can", "vac"], -38.980723),
    (["ch2", "ccsd(t)", "energy", "can", "occ"], -38.979818),
    (["ch2", "ccsd(t)", "energy", "can", "mixed"], -38.979822),
    (["ch2", "ccsd(t)", "dipole", "can", "vac"], np.array([0.0, 0.22567981, 0.0])),
    (["ch2", "ccsd(t)", "dipole", "can", "occ"], np.array([0.0, 0.22887061, 0.0])),
    (["ch2", "ccsd(t)", "dipole", "can", "mixed"], np.array([0.0, 0.22918507, 0.0])),
    ...
    (["ch2", "fci", "dipole", "can", "vac"], np.array([0.0, 0.22544755, 0.0])),
    (["ch2", "fci", "dipole", "can", "occ"], np.array([0.0, 0.22875506, 0.0])),
    (["ch2", "fci", "dipole", "can", "mixed"], np.array([0.0, 0.22910716, 0.0])),
    (["ch2", "fci", "dipole", "ccsd", "vac"], np.array([0.0, 0.22972397, 0.0])),
    (["ch2", "fci", "dipole", "ccsd", "occ"], np.array([0.0, 0.22905094, 0.0])),
    (["ch2", "fci", "dipole", "ccsd", "mixed"], np.array([0.0, 0.22912233, 0.0])),
    (["ch2", "fci", "dipole", "ccsd(t)", "vac"], np.array([0.0, 0.22977128, 0.0])),
