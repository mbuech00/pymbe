				...
				with open(self.output,'a') as f:
					with redirect_stdout(f):
						...
						print(('{0:12}{1:9}{2:7}{3:1}{4:2}{5:<12s}{6:3}{7:1}{8:9}{9:17}{10:2}{11:1}'
							'{12:2}{13:<8s}{14:5}{15:1}{16:7}{17:21}{18:2}{19:1}{20:2}{21:<2d}{22:^3}{23:<d}').\
						...
						print(('{0:12}{1:11}{2:5}{3:1}{4:2}{5:<5}{6:10}{7:1}{8:9}{9:9}{10:10}{11:1}'
							'{12:2}{13:<8s}{14:5}{15:1}{16:7}{17:10}{18:14}{19:1}{20:2}{21:.6f}').\
								format('','frozen core','','=','',str(_mol.frozen),\
									'','|','','exp. base','','=','',_calc.exp_base,\
									'','|','','HF energy','','=','',_mol.hf.e_tot))
						print(('{0:12}{1:14}{2:2}{3:1}{4:2}{5:<2d}{6:^3}{7:<4d}{8:6}{9:1}{10:9}{11:14}{12:5}'
							'{13:1}{14:2}{15:<8s}{16:5}{17:1}{18:7}{19:18}{20:6}{21:1}{22:2}{23:.6f}').\
								format('','# occ. / virt.','','=','',_mol.nocc-_mol.ncore,'/',_mol.nvirt,\
									'','|','','exp. type','','=','',_calc.exp_type,\
									'','|','','base model energy','','=','',_mol.hf.e_tot + _mol.e_zero))
						print(('{0:12}{1:14}{2:2}{3:1}{4:2}{5:<4s}{6:^3}{7:<4s}{8:4}{9:1}{10:9}{11:14}{12:5}{13:1}{14:2}'
							'{15:<6.2f}{16:7}{17:1}{18:7}{19:18}{20:6}{21:1}{22:2}{23:.6f}').\
								format('','orbitals (o/v)','','=','',_calc.exp_occ,'/',_calc.exp_virt,\
									...
									'','|','','final total energy','','=','',_mol.hf.e_tot + _exp.energy_tot[-1]))
						print(('{0:12}{1:8}{2:8}{3:1}{4:2}{5:<9s}{6:6}{7:1}{8:9}{9:16}{10:3}{11:1}{12:2}'
							'{13:<5.2e}{14:5}{15:1}{16:7}{17:17}{18:7}{19:1}{20:2}{21:>.2e}').\
